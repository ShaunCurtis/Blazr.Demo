...
public class DateOnlyValidator : Validator<DateOnly>
{
    ...
    public DateOnlyValidator(DateOnly value, string fieldName, ValidationMessageCollection validationMessages, ValidationState validationState, string? message)
...
public static class DateOnlyValidatorExtensions
{
    ...
    public static DateOnlyValidator Validation(this DateOnly value, string fieldName, ValidationMessageCollection validationMessages, ValidationState validationState, string? message = null)
        => new DateOnlyValidator(value, fieldName, validationMessages, validationState, message);
