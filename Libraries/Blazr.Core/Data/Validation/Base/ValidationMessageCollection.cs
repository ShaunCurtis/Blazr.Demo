...
public record ValidationMessage(FieldReference Field, string Message);
...
public class ValidationMessageCollection : IEnumerable<ValidationMessage>
{
    ...
    public void Add(FieldReference field, string message)
        => _messages.Add(new ValidationMessage(field, message));

    public void Add(FieldReference field, IEnumerable<string> messages)
    {
