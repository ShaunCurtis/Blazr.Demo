...
public class GuidValidator : ValidatorBase<Guid>
{
    ...
    public GuidValidator(Guid value, FieldReference field, ValidationMessageCollection validationMessages, ValidationState validationState, string? message) 
...
public static class GuidValidatorExtensions
{
    ...
    public static GuidValidator Validation(this Guid value, FieldReference field, ValidationMessageCollection validationMessages, ValidationState validationState, string? message = null) 
        => new GuidValidator(value, field, validationMessages, validationState, message);
