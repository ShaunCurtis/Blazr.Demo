...
public class InvoiceAggregate
{
    ...
    public InvoiceAggregate(IServiceProvider serviceProvider)
    {
    ...
    public InvoiceAggregate(IServiceProvider serviceProvider, DmoInvoice invoice, IEnumerable<DmoInvoiceItem> invoiceItems, bool isNew = false)
    {
        _serviceProvider = serviceProvider;
    ...
    {
        // persist the Invoice
        _invoice.Dispatch(new SetInvoiceAsPersistedAction());
        ...
        foreach (var item in _invoiceItems.Items)
            _invoiceItems.Dispatch(item.Id, new SetInvoiceItemAsPersistedAction());
    }
