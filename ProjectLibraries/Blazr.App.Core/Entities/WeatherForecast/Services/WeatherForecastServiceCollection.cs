...
public static class WeatherForecastServiceCollection
{
    public static void AddWeatherForecastServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IEditService<WeatherForecastEditContext, DboWeatherForecast>, StandardEditService<WeatherForecastEditContext, DboWeatherForecast, WeatherForecastEntity>>();
