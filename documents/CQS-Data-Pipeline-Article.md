...
All the CQS implementations I've seen are rather verbose.  The number of classes you need to create and maintain scared me.
...
You can apply the pattern to all object methods: I do.
...
It certainly scared me off when I first investigated CQS.
